...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An intimate hair, color & beauty atelier where every appointment is composed like couture." },
      { property: "og:title", content: "Maison Lilas — Hair & Beauty Atelier" },
      { property: "og:description", content: "An intimate hair, color & beauty atelier where every appointment is composed like couture." },
